...
column(12,
  br(),
  column(4, selectInput('yrsel', 'Select year on map:', choices = allsg$yr, selected = '2024')),
...
fillCol(flex = c(NA, 1),
  column(12, 
    ...
    column(4, selectInput('yrcmp1', 'Choose first year:', choices = allsg$yr, selected = '2022')),
    column(4, selectInput('yrcmp2', 'Choose second year:', choices = allsg$yr, selected = '2024'))
  ),
  renderUI({
