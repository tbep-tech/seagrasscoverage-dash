...
allmap <- reactive({
  ...
  colreg <- cols[levels(sgdat$Category)]
...
```{r}
output$snksegplo <- renderSankeyNetwork(snksegplo())
fillCol(flex = c(NA, 1),
  column(12, 
    ...
    column(4, numericInput('nodpd2', 'Change spacing:', min = 0, max = 300, step = 10, value = 100))
    ),
  sankeyNetworkOutput('snksegplo')
)
```
